...
int stack_push(struct stack& s, char newElement)
{
   ...
   */
    ...
    if (ptrTemp == NULL)                        // in case we cannot get a allocated memory back
        return -1;                              // exit from a function
...
int stack_pop(struct stack& s)
{
    ...
    */
    ...
    if(s.elements != 0) // 4a. If the array is not empty (stack is not empty)
    {
